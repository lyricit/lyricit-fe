      ...
      <div className="absolute bottom-0 h-9 w-[178px]">
        ...
        {isMaster ? (
          <div className="inline-flex h-full w-full items-center justify-center rounded-b-[8px] border-black bg-gradient-to-l from-rose-600 to-sky-400">
            <span className="relative z-0 text-center font-semibold text-sm text-stroke text-white leading-none after:stroke-width-2 after:text-stroke-black after:content-['방장']">
              {isMaster ? '방장' : null}
            </span>
          </div>
        ) : info.isReady ? (
          <div className="inline-flex h-full w-full items-center justify-center rounded-b-[8px] border-black bg-amber-300">
            <span className="relative z-0 text-center font-semibold text-sm text-stroke text-white leading-none after:stroke-width-2 after:text-stroke-black after:content-['준비완료']">
              준비완료
            </span>
          </div>
        ) : null}

    ...
    <div>
      <div className="flex items-center gap-2.5 p-5">
        ...
        <div className="inline-flex flex-col items-start justify-center gap-2.5 p-2.5">
          <h1 className="select-text self-stretch font-semibold text-base text-neutral-100 leading-tight">
            {title}
          </h1>
          <p className="select-text self-stretch font-normal text-neutral-200 text-sm leading-none">
            {artist}
          </p>
        </div>
      </div>
